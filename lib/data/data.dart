...
import 'package:flutter_test_resturant/models/order.dart';
import 'package:flutter_test_resturant/models/restaurant.dart';
import 'package:flutter_test_resturant/models/user.dart';
...
final _restaurant0 = Restaurant(
  ...
  name: 'Royal Kashmir (Issy les moulineaux)',
  address: '12 Rue Ernest Renan, 92130 Issy-les-Moulineaux',
  rating: 4,
...
final _restaurant1 = Restaurant(
  ...
  name: 'LE PATIO',
  address: '3 Rue Henri Mayer, 92130 Issy-les-Moulineaux,',
  rating: 3,
  menu: [_steak, _pasta, _ramen, _pancakes, _burger, _pizza],
);
final _restaurant2 = Restaurant(
  imageUrl: 'assets/images/restaurant2.jpg',
  name: 'Restaurant Manufacture',
  address: '20 Esp. de la Manufacture, 92130 Issy-les-Moulineaux,',
  rating: 4,
...
final _restaurant3 = Restaurant(
  ...
  name: 'L ile',
  address: '170 Quai de Stalingrad Parc de l’Ile Saint-Germain, 92130 Issy-les-Moulineaux,',
  rating: 3,
...
final _restaurant4 = Restaurant(
  ...
  name: 'La Passerelle',
  address: '172 Quai de Stalingrad, 92130 Issy-les-Moulineaux,',
  rating: 3,
